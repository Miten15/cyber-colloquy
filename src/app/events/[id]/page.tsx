    ...
    <Container>
        ...
        <div className="mt-4">
          ...
          <ul className="text-gray-700 list-disc list-inside inline-block">
            {event.colloquyDetails?.topics.map((topic, index) => (
              <li key={index} className="text-gray-800 dark:text-gray-200">{topic}</li>
            ))}
          </ul>
        </div>
      </div>
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {["21st March", "22nd March", "23rd March", "24th March"].map((day) => (
              <div key={day} className="bg-gray-100 dark:bg-gray-700 rounded-md p-4">
                            ...
                            .map((activity, index) => (
                             <div key={index} className="flex flex-col md:flex-row items-center">
                                <div className="md:w-1/2 pr-2 flex justify-center">
                                  <Image src={activity.image} alt={activity.description} width={200} height={150} />
                                </div>
